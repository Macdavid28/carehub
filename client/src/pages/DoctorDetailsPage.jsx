        ...
        <div className="h-56 md:h-80 bg-[url('https://images.unsplash.com/photo-1622253692010-333f2da6031d?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center relative">
          ...
          <div className="absolute top-6 left-6 z-10 flex gap-4">
            ...
            {user?.role === "admin" && (
              <Button
                variant="ghost"
                className="text-white bg-primary-600/50 hover:bg-primary-600 backdrop-blur-md rounded-xl"
        ...
        <div className="px-6 md:px-12 pb-10">
          <div className="relative flex flex-col items-center md:items-end md:flex-row -mt-20 md:-mt-32 mb-6 gap-8">
            <motion.div
              ...
              className="w-40 h-40 md:w-56 md:h-56 rounded-full bg-white p-2 shadow-2xl z-20 border-[6px] border-white ring-1 ring-slate-100"
          >
              <div className="w-full h-full rounded-full bg-gradient-to-br from-indigo-50 to-primary-50 flex items-center justify-center text-primary-700 font-black text-5xl md:text-7xl shadow-inner uppercase">
            ...
            <div className="flex-1 text-center md:text-left pb-2">
              <div className="flex flex-col md:flex-row items-center md:items-end gap-3 mb-4">
                ...
                <div className="flex items-center gap-2 bg-amber-50 text-amber-700 px-4 py-1.5 rounded-full text-[10px] font-black border border-amber-100 tracking-widest w-40 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
              <Button className="hms-gradient-blue rounded-2xl py-4 px-4 font-black tracking-widest text-xs shadow-xl shadow-primary-200 group">
            ...
            <div className="premium-card p-8 bg-white border-t-8 border-primary-500 shadow-primary-100">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-center gap-3 text-slate-600 font-bold text-sm bg-slate-50 p-3 rounded-xl"
                  >
            ...
            <div className="premium-card p-8 bg-white border-t-8 border-indigo-500 shadow-indigo-100">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-center gap-3 text-slate-600 font-bold text-sm bg-indigo-50 p-3 rounded-xl border border-indigo-100/50"
                  >
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-emerald-100 text-xs font-bold uppercase tracking-widest opacity-60">
                    Secure Credentials
                  </p>
                </div>
              </div>
